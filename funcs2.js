...
$(document).ready(function(){
    ...
    function show(lancs, movs){
        ...
        for(var key in lancs){
            if(key != 0){
                ...
                action.addClass(`del-${lancs[key].id} delete-click`);
    ...
    window.getIdUser = function(){
        return id_user;
    }
    
    window.callShow = function(lancs,movs){
        show(lancs,movs);
    }

    window.callCalc = function(obj){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response){
                    ...
                    let calculado = window.callCalc(response);
